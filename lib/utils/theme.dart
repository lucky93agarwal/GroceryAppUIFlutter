...
import 'package:grocery/utils/config.dart';
...
class ThemeModel {
  final lightTheme = ThemeData(
    ...
    textTheme: TextTheme(
      headline1: TextStyle(color: Color(0xff13213e), fontSize: 13,letterSpacing: 1.0, fontWeight: FontWeight.w900,),
      headline2: TextStyle(color: Color(0xff13213e), fontWeight: FontWeight.w900, fontSize: 14,),
      headline3: TextStyle(color: Color(0Xff202e55), fontWeight: FontWeight.w900, fontSize: 16,),
      headline4: TextStyle(color: Color(0xff13213e), fontWeight: FontWeight.bold, fontSize: 22,),
      ...
      subtitle2: TextStyle(color: Color(0xff888888), fontSize: 11, fontWeight: FontWeight.w900,),
